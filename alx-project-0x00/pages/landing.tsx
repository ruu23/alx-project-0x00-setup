    ...
    <div>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen gap-4 bg-gray-50">
        ...
        <div className="flex gap-3">
          ...
          <Button title="Small - Rounded Large" styles="text-sm rounded-lg px-3 py-1" />
        ...
        <div className="flex gap-3">
          ...
          <Button title="Medium - Rounded Large" styles="text-base rounded-lg px-4 py-2" />
        ...
        <div className="flex gap-3">
          ...
          <Button title="Large - Rounded Large" styles="text-lg rounded-lg px-6 py-3" />
